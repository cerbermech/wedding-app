...
export default function Program() {
  ...
  const timeline = [

    {
      time: "15:00-15:30",
      icon: Gem,
      text: "Официальная регистрация в ЗАГСе: г. Екатеринбург, ул. Карла Либкнехта, д. 3",
    },
    { time: "15:35-16:30", icon: Car, text: "Трансфер до площадки: у ЗАГСа гостей будет ждать автобус" },
    ...
    <div className="program-container">
      ...
      <section className="arrival-note" aria-label="Как приехать на мероприятие">
        ...
        <p>
          ...
          к 16:00. После регистрации у ЗАГСа гостей будет ждать автобус, который отвезёт всех на площадку.
        </p>
        <p>
